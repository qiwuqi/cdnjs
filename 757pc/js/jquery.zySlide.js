...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 122, height: 160, top: 43, left: 31, $opacity: 0.5 },
            { '&zIndex': 2, width: 145, height: 190, top: 29, left: 79, $opacity: 1 },
            { '&zIndex': 1, width: 122, height: 160, top: 43, left: 151, $opacity: 0.5 }
        ]
    ...
    Slide.prototype = {
        ...
        move: function () {
            ...
            this.lis.each(function (i, el) {
				...
				if (this.states[i]['&zIndex'] == 2) {
					$(this.options.txtids).hide();
					var list = $(this.options.txtids);
					$(list[i]).show();
				}
            }.bind(this))
        },
